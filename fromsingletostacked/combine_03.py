...
input_flcs = glob.glob('data/flc_f606w/*flc.fits')
visit_nums = []
...
collec = ImageFileCollection('data/flc_f606w/', glob_include="*flc.fits", ext=0,
...
for visit_num in visit_nums:
    input = glob.glob(f'data/flc_f606w/j8m8{visit_num}*.fits')

    tweakreg.TweakReg(input,
    ...
    astrodrizzle.AstroDrizzle(input,
